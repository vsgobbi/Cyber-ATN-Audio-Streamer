...
'''
 ...
 UDPSniffer handles only User Datagram Protocol Packets
'''
...
# receive a packet
while True:
    packet = s.recvfrom(65565) #specify the port number
    ...
    if eth_protocol == 8 :
        ...
        if protocol == 17 :
            ...
            print 'Source Port : ' + str(source_port) + ' Dest Port : ' + str(dest_port) + ' Length : ' + str(length) + ' Checksum : ' + str(checksum) +' Protocol : ' + str(eth_protocol) + '\nData : ' + str(data)
